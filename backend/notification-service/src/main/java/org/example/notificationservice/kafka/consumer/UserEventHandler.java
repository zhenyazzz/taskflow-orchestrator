...
public class UserEventHandler {
    ...
    public void consumeUserCreated(UserCreatedEvent event) {
        ...
        userNotificationService.handleUserCreated(event).subscribe();
    }
    ...
    public void consumeUserRegistered(UserRegistrationEvent event) {
        ...
        userNotificationService.handleUserRegistered(event).subscribe();
    }
    ...
    public void consumeUserProfileUpdated(UserProfileUpdatedEvent event) {
        ...
        userNotificationService.handleUserProfileUpdated(event).subscribe();
    }
    ...
    public void consumeUserDeleted(UserDeletedEvent event) {
        ...
        userNotificationService.handleUserDeleted(event).subscribe();
    }
    ...
    public void consumeUserRoleUpdate(UserRoleUpdateEvent event) {
        ...
        userNotificationService.handleUserRoleUpdate(event).subscribe();
    }
    ...
    public void consumeUserLogin(UserLoginEvent event) {
        ...
        userNotificationService.handleUserLogin(event).subscribe();
    }
    ...
    public void consumeLoginFail(LoginFailEvent event) {
        ...
        userNotificationService.handleLoginFail(event).subscribe();
    }
}
